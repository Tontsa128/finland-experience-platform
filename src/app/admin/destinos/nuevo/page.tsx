...
export default function NewDestinationPage() {
  ...
  const [mediaIds, setMediaIds] = useState<string[]>([]); const [form, setForm] = useState({ nameEs: '', nameFi: '', nameEn: '', slug: '', region: '', descriptionEs: '', descriptionFi: '', descriptionEn: '', imageUrl: '', status: 'published' as 'draft'|'published', publishAt: '', seoTitleFi:'', seoTitleEs:'', seoTitleEn:'', seoDescriptionFi:'', seoDescriptionEs:'', seoDescriptionEn:'' });
  ...
  async function submit(event: FormEvent) {
    ...
    const payload = {
      ...
      heroImageUrl: form.imageUrl.trim() || undefined,
      mediaIds, status: form.status, publishAt: form.publishAt ? new Date(form.publishAt).toISOString() : null,
      seo: { fi:{title:form.seoTitleFi,description:form.seoDescriptionFi}, es:{title:form.seoTitleEs,description:form.seoDescriptionEs}, en:{title:form.seoTitleEn,description:form.seoDescriptionEn} },
      translations: {
